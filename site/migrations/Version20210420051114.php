 ...
 */
final class Version20210420051114 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL, prenom VARCHAR(30) DEFAULT NULL, anniversaire DATE DEFAULT NULL, identifiant VARCHAR(30) NOT NULL COLLATE BINARY --sert de login (doit etre unique)
